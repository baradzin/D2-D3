...
namespace Task2
{
    class HttpClientDownloadWithProgress
    {
        ...
        public delegate void DownloadFileCompletedHandler(long? totalFileSize);

        public event ProgressChangedHandler ProgressChanged;
        public event DownloadFileCompletedHandler DownloadFileCompleted;

        public HttpClientDownloadWithProgress(HttpClient client, string downloadUrl, string destinationFilePath, CancellationToken? cancellationToken = null)
        {
            _httpClient = client;
        ...
        private async Task ProcessContentStream(long? totalDownloadSize, Stream contentStream)
        {
            ...
            TriggerProgressChanged(totalDownloadSize, totalBytesRead);
            DownloadFileCompleted(totalDownloadSize);
        }
